...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'Grades': const GradesWidget(),
      'Elements': const ElementsWidget(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        margin: const EdgeInsetsDirectional.fromSTEB(18.0, 8.0, 18.0, 8.0),
        ...
        items: [
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 0 ? Icons.cottage : Icons.cottage_outlined,
